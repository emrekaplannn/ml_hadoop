...
public class TitleExperience {
    public static class TitleExperienceMapper extends Mapper<Object, Text, Text, LongWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            String jobTitleExperience = fields[3] + "_" + fields[1]; // job_title_experience_level
            long salary = Long.parseLong(fields[4]);
            context.write(new Text(jobTitleExperience), new LongWritable(salary));
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "Average Salary by Job Title and Experience Level");
